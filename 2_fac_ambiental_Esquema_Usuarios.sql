...
-- Se establece conexión co la base de datos de la facultad de ingeniería. 
SELECT dblink_connect('fac_ingenieria','dbname=fac_ingenieria port= 5432 user=postgres password=postgres');
